...
type Article struct {
	...
	Author       string `gorm:type:varchar(16);not null;comment:文章作者 json:"author"`
	UpdateStatus int8   `gorm:"type:tinyint;comment:更新状态(1-更新 2-断更 3-完结)" json:"update_status"`
}
